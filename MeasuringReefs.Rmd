...
* Open the .csv datasheet template ("Module1_MeasuringReefs_template.csv") 
    + Do not add/delete columns since we will combine datasets later
    + Re-save file with your initials appended to the end of the filename (e.g., "Module1_MeasuringReefs_EPM.csv")
