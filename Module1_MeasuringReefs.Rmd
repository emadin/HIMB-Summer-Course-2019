...
* Clone repository https://github.com/emadin/HIMB-Summer-Course-2019-Remote-Sensing-Imagery-Module-1-Measuring-Reefs-, which will allow you to open the .csv datasheet template ("Module1_MeasuringReefs_template.csv") 
...
* Open saved .csv datasheet template adn re-save with your initials appended to the end of the filename (e.g., "Module1_MeasuringReefs_EM.csv")
    + Column headings in red are those you’ll be filling in
